...
public class UserServiceTest {
	...
	public void setUp() {
		users = Arrays.asList(
				...
				new User("erwins", "신승환", "p3", Level.SILVER, 60, MIN_RECCOMEND_FOR_GOLD -1, "skarudvy0202@daum.net"),
				new User("madnite1", "이상호", "p4", Level.SILVER, 60, MIN_RECCOMEND_FOR_GOLD, "skarudvy0202@naver.com"),
